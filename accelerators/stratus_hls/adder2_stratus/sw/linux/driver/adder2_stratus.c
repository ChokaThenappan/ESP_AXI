...
#include "adder2_stratus.h"

#define DRV_NAME	"adder2_stratus"

/* <<--regs-->> */
#define ADDER2_SIZE_REG 0x40

struct adder2_stratus_device {
...
static struct of_device_id adder2_device_ids[] = {
	{
		.name = "SLD_ADDER2_STRATUS",
	},
	{
		.name = "eb_098",
	},
	{
		.compatible = "sld,adder2_stratus",
	},
	{ },
};
...
static inline struct adder2_stratus_device *to_adder2(struct esp_device *esp)
{
	return container_of(esp, struct adder2_stratus_device, esp);
}

static void adder2_prep_xfer(struct esp_device *esp, void *arg)
{
	struct adder2_stratus_access *a = arg;
...
{
	/* struct adder2_stratus_device *adder2 = to_adder2(esp); */
	/* struct adder2_stratus_access *a = arg; */
...
{
	struct adder2_stratus_device *adder2;
	struct esp_device *esp;
	int rc;
...
static struct esp_driver adder2_driver = {
	...
	.ioctl_cm	= ADDER2_STRATUS_IOC_ACCESS,
	.arg_size	= sizeof(struct adder2_stratus_access),
};
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("adder2_stratus driver");
