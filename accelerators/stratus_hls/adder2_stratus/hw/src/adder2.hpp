...
#ifndef __ADDER2_HPP__
#define __ADDER2_HPP__

#include "adder2_conf_info.hpp"
#include "adder2_debug_info.hpp"

#include "esp_templates.hpp"

#include "adder2_directives.hpp"
...
class adder2 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(adder2);
    adder2(const sc_module_name& name)
